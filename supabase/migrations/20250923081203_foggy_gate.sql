/*
  ...
  1. New Data
    - Insert all test users for complete testing coverage
    - Agent, Admin, Admin Manager, and Super User accounts
    
  2. Security
    - All accounts set to active status
    - Proper role assignments for each tier
*/

-- Insert/update all test users to ensure they exist
